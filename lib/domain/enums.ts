...
export const gameLanguageCategorySchema = z.enum([
  "AUDIO",
  "SUBTITLES",
  "INTERFACE",
]);
...
export type GameLibraryProgressState = z.infer<
  typeof gameLibraryProgressStateSchema
>;
...
export const consoleFamilySchema = z.enum([
  "PLAY",
  "XBOX",
  "SEGA",
  "LINUX",
